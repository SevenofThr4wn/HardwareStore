        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    order_status = table.Column<int>(type: "int", maxLength: 20, nullable: false),
                    order_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updated_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    shipping_address = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    shipping_city = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    shipping_postal_code = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    shipping_country = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.order_id);
                    table.ForeignKey(
                        name: "FK_Orders_AppUsers_user_id",
                        column: x => x.user_id,
